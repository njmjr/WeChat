...
using System.IO;
using System.Linq;
using WeChat.Utility.Properties;

namespace WeChat.Utility.Extensions
{
    /// <summary>
    /// 用于参数检查的扩展方法
    /// </summary>
    public static class ParamterCheckExtensions
    {
        ...
        public static void CheckNotNullOrEmpty(this string value, string paramName)
        {
            ...
            Require<ArgumentException>(value.Length > 0, string.Format(Resource.ParameterCheck_NotNullOrEmpty_String, paramName));
        }
        ...
        public static void CheckDirectoryExists(this string directory, string paramName = null)
        {
            ...
            Require<DirectoryNotFoundException>(Directory.Exists(directory), string.Format(Resource.ParameterCheck_DirectoryNotExists, directory));
        }
        ...
        public static void CheckFileExists(this string filename, string paramName = null)
        {
            ...
            Require<FileNotFoundException>(File.Exists(filename), string.Format(Resource.ParameterCheck_FileNotExists, filename));
        }
    }
}